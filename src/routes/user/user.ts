...
import { add_location, del_location, primary_location } from '../../controllers/user/locationController';
import { allweather_reports, detailed_report } from '../../controllers/user/userController';
...
router.get('/home/:userId', allweather_reports);
...
router.get('/weather-report/:userId', detailed_report);
...
router.delete('/location/:lat/:lng', del_location);
...
router.put('/primary-location/:lat/:lng', primary_location);
